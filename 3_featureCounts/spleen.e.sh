...
WORKDIR=/scratch2/alanxu/2019_killi_rna_raw/bam_sorted/spleen
cd $WORKDIR
...
-F GTF -O -T 20 -p --countReadPairs -o /scratch2/alanxu/2019_killi_rna_raw/featurecount/spleen_exon.txt \
*.bam
